      ...
      <div className="flex flex-col-reverse lg:flex-row mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-20">
        <div className="mx-auto max-w-2xl px-4 lg:mx-0 lg:shrink-0">
          ...
          <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
            We are a mutual aid network rooted in friendship and collective
            action directly connected with families in Gaza and with each other.
            As champions for their fundraising efforts, we support their daily
            survival while building meaningful relationships across borders.
          </p>
          <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
            Through virtual gatherings, strategy sessions, and community events,
            we come together to share ideas, uplift one another, and deepen our
            commitment to solidarity. This is more than a fundraising
            effort—it’s a movement of care, connection, and shared resilience.
          </p>
          <div className="mt-10 flex items-center gap-x-6">
            ...
            >
              See the funds we&apos;re supporting{" "}
              <span aria-hidden="true">→</span>
            </Link>
          </div>
        </div>
        <div className="relative rounded grow overflow-hidden h-[25vh] lg:h-auto">
          <div className="bg-hero w-[400%] bg-contain h-full bg-repeat-x lg:animate-scroll absolute"></div>
        </div>
      </div>
      {isClient && (
        <>
